...
import com.oms.system.audit.OpLogInterceptor;
import com.oms.system.auth.AuthInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    /** 允许跨域的前端来源，逗号分隔（oms.cors.origins / OMS_CORS_ORIGINS）；同源部署可留空 */
    @Value("${oms.cors.origins:http://localhost:5173}")
